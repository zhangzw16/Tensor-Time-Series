...
class AGCRN(nn.Module):
    def __init__(self, num_nodes, input_dim, hidden_dim, output_dim, horizon, num_layers, default_graph, embed_dim, cheb_k):
        ...
        self.encoder = AVWDCRNN(num_nodes, input_dim, self.rnn_units, cheb_k,
