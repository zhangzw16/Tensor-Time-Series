...
class Mamba(nn.Module):
    ...
    def forward(self, x):
        ...
        return out.view(batch_size, self.pred_len, self.num_nodes, self.output_dim)
...
class Mamba_TensorModel(TensorModelBase):
    ...
    def init_model(self, args=...):
        ...
        self.milestones = model_configs['milestones']
        self.lr_decay_rate = model_configs["lr_decay_rate"]

        self.model = Mamba(num_nodes=self.num_nodes, 
