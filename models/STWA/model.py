...
# https://github.com/razvanc92/ST-WA
import torch
...
class STWA_MultiVarModel(MultiVarModelBase):
    ...
    def init_others(self):
        ...
        self.input_dim = self.data_shape[1] # 1
    ...
    def init_model(self, args=...):
        ...
        self.channels = model_configs['channels'] 
        self.dynamic = model_configs['dynamic']
        self.memory_size = model_configs['memory_size']
        ...
        self.model = STWA(num_nodes=self.num_nodes,
                          device=self.device,
