...
class Model(nn.Module):
    ...
    def __init__(self, input_len, pred_len, enc_in, dec_in, c_out, 
                 e_layers, d_model, embed, top_k, d_ff, num_kernels, freq, dropout):
        ...
        if self.task_name == 'classification':
            ...
            self.projection = nn.Linear(
                d_model * self.seq_len, self.num_class)
