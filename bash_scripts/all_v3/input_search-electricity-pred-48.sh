...
# 模型配置
ModelList=("AutoFormer" "CrossFormer" "PatchTST" "DLinear" "NLinear" "Mamba" "MTGNN" "ST_Norm" "TimesNet" "StemGNN" "STID" "AGCRN" "GCGRU" "GraphWaveNet" "STWA" "NET3" "DCRNN")
