...
# 模型配置
ModelList=("AutoFormer" "CrossFormer" "PatchTST" "DLinear" "NLinear" "Mamba" "MTGNN" "ST_Norm" "TTS_Norm" "TimesNet" "StemGNN" "STID" "AGCRN" "GCGRU" "GraphWaveNet" "STWA" "NET3" "DCRNN")
...
DatasetList=('crypto12' 'METRO_HZ' 'ETT' 'weather')
