...
# 模型配置
ModelList=("NET3_unit" "NET3_MLP" "GraphWaveNet_unit" "GraphWaveNet_wo_GCN" "GraphWaveNet_wo_GCN_TCN" "MTGNN_wo_GCN" "MTGNN_unit")
        ...
        for model in ${ModelList[@]}; do
            for dataset in ${DatasetList[@]}; do
                ...
                python3 main_cli.py --task_name $task_name --output_dir $output_dir --train_test $train_test --device $device \
                    ...
                    --normalizer $normalizer --graph_init 'unit' \
