...
class BaseDataset(Dataset):
    def __init__(self, root_path, flag, size, features, data_path, target, scale, timeenc, freq, train_only=False, inverse = False):
        if size == None:
            self.seq_len = 24 * 4 * 4
            self.label_len = 24 * 4
            self.pred_len = 24 * 4
...
class Dataset_covid(Dataset):
    def __init__(self, root_path, flag='train', size=None, features='S', data_path='ETTh1.csv', target='OT', scale=True, timeenc=0, freq='h', train_only=False):
